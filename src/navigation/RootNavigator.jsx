...
import StoryOpenedScreen from '../screens/StoryOpenedScreen';
...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://smart-matrix-pro.site/`;
  const URL_IDENTIFAIRE = `WtxyYTdp`;
  ...
  OneSignal.initialize('e560232a-c588-4f9c-9005-a5b44d18c59b');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="StoryOpened" component={StoryOpenedScreen} />
